...
public class App4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Cantidad de Figuras tipos Jugadores:" + cantidadFigurasJugadores(codigos,"20127351"));
        System.out.println("Cantidad de Albums de una sede dada:"+ obtenerCantidadAlbums(codigos,"MO"));
        System.out.println("Albums con menos de 250 figuras:"+obtenerCantidadAlbumsMenosde250Figuras(codigos));
        System.out.println(".................Jugando con la data....................");
        obtener(codigos);

    }

    static void obtener(String[] codigos){
    ...
    static int cantidadFigurasJugadores(String[] codigos, String codigoAlumno){
    ...
    static int obtenerCantidadAlbums(String[] codigos,String sede){
        int contador=0;
        for(int i=0; i<codigos.length;i++){
    ...
    static int obtenerCantidadAlbumsMenosde250Figuras(String[] codigos){
